  ...
  <body>
    ...
    <div class="cart-box-main">
        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="nama_subdistrict" id="" class="form-control">
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="order-box">
                                        ...
                                        <div class="d-flex">
                                            <h4>Shipping Cost</h4>
                                            <div class="ml-auto font-weight-bold"> <input type="text" class="form-control" name="ongkir" style="border:none; background: none; text-align: right; margin-left: 13px;"> </div>
                                        </div>
                                        <hr>
                                        <div class="d-flex gr-total">
                                            <h5>Grand Total</h5>
                                            <div class="ml-auto font-weight-bold"><div class="total"></div></div>
                                        </div>
                                        <hr> </div>
                                    </div>
          ...
          unset($_SESSION["cart"]);
          echo "<script>window.location.href='detail_pesanan.php?id=".$id_transaksi."';</script>";
          die();
      }
      ?>
...
<script>
    $(document).ready(function(){
      ...
      $("select[name=nama_ekspedisi]").on("change", function(){
        ...
        var subdistrict_dipilih=$("input[name=kecamatan]").val();
        $total_berat = $("input[name=total_berat]").val();
        $.ajax({
          type: 'post',
          url: 'rajaongkir/datapaket.php',
          data: 'ekspedisi='+ekspedisi_terpilih+'&subdistrict='+subdistrict_dipilih+'&berat='+$total_berat,
      ...
      $("select[name=nama_distrik]").on("change", function(){
        ...
        $.ajax({
          type: 'post',
          url: 'rajaongkir/datasubdistrict.php',
          data: 'id_city='+id_distrik,
          success:function(hasil_distrik){
            $("select[name=nama_subdistrict]").html(hasil_distrik);
        }});
      ...
      $("select[name=nama_subdistrict]").on("change", function(){
